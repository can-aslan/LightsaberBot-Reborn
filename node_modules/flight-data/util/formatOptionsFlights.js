...
function checkCorrectOptions(options) {
  ...
  if (dep_iata !== undefined && (dep_iata.length > 3)) {
    throw new Error(`dep_iata code should be 3 digits long. ${VISIT}`);
  }
  if (arr_iata !== undefined && (arr_iata.length > 3)) {
    throw new Error(`arr_iata code should be 3 digits long. ${VISIT}`);
  }
